...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean k=testadd.isEqual(outadd);
        boolean m=testmult.isEqual(outmult);
        if(k==true) System.out.println("Mult is correct!");
          else System.out.println("Mult is not correct");

        if(m==true) System.out.println("Add is correct!");
